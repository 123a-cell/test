...
--
-- Host: localhost    Database: springboot0l9bgn3u
-- ------------------------------------------------------
...
--
-- Current Database: `springboot0l9bgn3u`
--

/*!40000 DROP DATABASE IF EXISTS `springboot0l9bgn3u`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springboot0l9bgn3u` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `springboot0l9bgn3u`;
...
INSERT INTO `config` VALUES (1,'picture1','upload/picture1.jpg',NULL),(2,'picture2','upload/picture2.jpg',NULL),(3,'picture3','upload/1742910500728.jpg',NULL);
...
CREATE TABLE `discussfuwuxinxi` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='服务信息评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `discussfuwuxinxi` VALUES (1,'2025-03-25 13:48:50',9,1742910398380,'upload/1742910369727.jpg','11','<p>测试3c</p>',NULL,'',0,0,0,'','');
...
CREATE TABLE `fuwufenlei` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `fuwufenlei` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '服务分类',
  PRIMARY KEY (`id`),
...
INSERT INTO `fuwufenlei` VALUES (1,'2025-03-25 13:17:47','服务分类1'),(2,'2025-03-25 13:17:47','服务分类2'),(3,'2025-03-25 13:17:47','服务分类3'),(4,'2025-03-25 13:17:47','服务分类4'),(5,'2025-03-25 13:17:47','服务分类5'),(6,'2025-03-25 13:17:47','服务分类6'),(7,'2025-03-25 13:17:47','服务分类7'),(8,'2025-03-25 13:17:47','服务分类8'),(9,'2025-03-25 13:47:02','分类1');
...
CREATE TABLE `fuwuxinxi` (
  ...
  `fuwumiaoshu` longtext COLLATE utf8mb4_unicode_ci COMMENT '服务描述',
  `discussnum` int(11) DEFAULT '0' COMMENT '评论数',
  `totalscore` double DEFAULT '0' COMMENT '评分',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='服务信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fuwuxinxi` VALUES (1,'2025-03-25 13:17:47','服务名称1','服务分类1','已预约','upload/fuwuxinxi_tupian1.jpg,upload/fuwuxinxi_tupian2.jpg,upload/fuwuxinxi_tupian3.jpg',1,'2025-03-25','服务描述1',0,0),(2,'2025-03-25 13:17:47','服务名称2','服务分类2','已预约','upload/fuwuxinxi_tupian2.jpg,upload/fuwuxinxi_tupian3.jpg,upload/fuwuxinxi_tupian4.jpg',2,'2025-03-25','服务描述2',0,0),(3,'2025-03-25 13:17:47','服务名称3','服务分类3','已预约','upload/fuwuxinxi_tupian3.jpg,upload/fuwuxinxi_tupian4.jpg,upload/fuwuxinxi_tupian5.jpg',3,'2025-03-25','服务描述3',0,0),(4,'2025-03-25 13:17:47','服务名称4','服务分类4','已预约','upload/fuwuxinxi_tupian4.jpg,upload/fuwuxinxi_tupian5.jpg,upload/fuwuxinxi_tupian6.jpg',4,'2025-03-25','服务描述4',0,0),(5,'2025-03-25 13:17:47','服务名称5','服务分类5','已预约','upload/fuwuxinxi_tupian5.jpg,upload/fuwuxinxi_tupian6.jpg,upload/fuwuxinxi_tupian7.jpg',5,'2025-03-25','服务描述5',0,0),(6,'2025-03-25 13:17:47','服务名称6','服务分类6','已预约','upload/fuwuxinxi_tupian6.jpg,upload/fuwuxinxi_tupian7.jpg,upload/fuwuxinxi_tupian8.jpg',6,'2025-03-25','服务描述6',0,0),(7,'2025-03-25 13:17:47','服务名称7','服务分类7','已预约','upload/fuwuxinxi_tupian7.jpg,upload/fuwuxinxi_tupian8.jpg,upload/fuwuxinxi_tupian1.jpg',7,'2025-03-25','服务描述7',0,0),(8,'2025-03-25 13:17:47','服务名称8','服务分类8','已预约','upload/fuwuxinxi_tupian8.jpg,upload/fuwuxinxi_tupian1.jpg,upload/fuwuxinxi_tupian2.jpg',8,'2025-03-25','服务描述8',0,0),(9,'2025-03-25 13:47:49','服务1','分类1','已预约','upload/1742910461717.jpg',200,'2025-03-25','基于Android的生活服务系统的设计与实现\n',1,0);
...
CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生活资讯';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `newstype` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生活资讯分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `newstype` VALUES (1,'2025-03-25 13:17:47','分类名称1'),(2,'2025-03-25 13:17:47','分类名称2'),(3,'2025-03-25 13:17:47','分类名称3'),(4,'2025-03-25 13:17:47','分类名称4'),(5,'2025-03-25 13:17:47','分类名称5'),(6,'2025-03-25 13:17:47','分类名称6'),(7,'2025-03-25 13:17:47','分类名称7'),(8,'2025-03-25 13:17:47','分类名称8'),(9,'2025-03-25 13:47:58','资讯分类');
...
CREATE TABLE `smsregistercode` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='短信验证码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smsregistercode` VALUES (1,'2025-03-25 13:17:47','手机1','角色1','验证码1'),(2,'2025-03-25 13:17:47','手机2','角色2','验证码2'),(3,'2025-03-25 13:17:47','手机3','角色3','验证码3'),(4,'2025-03-25 13:17:47','手机4','角色4','验证码4'),(5,'2025-03-25 13:17:47','手机5','角色5','验证码5'),(6,'2025-03-25 13:17:47','手机6','角色6','验证码6'),(7,'2025-03-25 13:17:47','手机7','角色7','验证码7'),(8,'2025-03-25 13:17:47','手机8','角色8','验证码8'),(9,'2025-03-25 13:46:25','13512312312','用户','707619');
...
INSERT INTO `storeup` VALUES (1,'2025-03-25 13:49:10',1742910398380,9,'news','生活资讯','upload/1742910490182.jpg','21',NULL,NULL),(2,'2025-03-25 13:49:11',1742910398380,9,'news','生活资讯','upload/1742910490182.jpg','1',NULL,NULL);
...
INSERT INTO `token` VALUES (1,1,'admin','users','管理员','g1nccjomejeb0l0ar80w571ernf3v6to','2025-03-25 13:46:44','2025-03-25 14:46:45'),(2,1742910398380,'11','yonghu','用户','y1azrgiy7n50hrjwdkrmh62452598je1','2025-03-25 13:48:25','2025-03-25 14:48:26');
...
INSERT INTO `users` VALUES (1,'admin','admin','upload/image1.jpg','管理员','2025-03-25 13:17:47');
...
) ENGINE=InnoDB AUTO_INCREMENT=1742910398381 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `yonghu` VALUES (11,'2025-03-25 13:17:47','用户账号1','123456','用户姓名1','男','upload/yonghu_touxiang1.jpg','13823888881','13823888881'),(12,'2025-03-25 13:17:47','用户账号2','123456','用户姓名2','男','upload/yonghu_touxiang2.jpg','13823888882','13823888882'),(13,'2025-03-25 13:17:47','用户账号3','123456','用户姓名3','男','upload/yonghu_touxiang3.jpg','13823888883','13823888883'),(14,'2025-03-25 13:17:47','用户账号4','123456','用户姓名4','男','upload/yonghu_touxiang4.jpg','13823888884','13823888884'),(16,'2025-03-25 13:17:47','用户账号6','123456','用户姓名6','男','upload/yonghu_touxiang6.jpg','13823888886','13823888886'),(17,'2025-03-25 13:17:47','用户账号7','123456','用户姓名7','男','upload/yonghu_touxiang7.jpg','13823888887','13823888887'),(18,'2025-03-25 13:17:47','用户账号8','123456','用户姓名8','男','upload/yonghu_touxiang8.jpg','13823888888','13823888888'),(1742910398380,'2025-03-25 13:46:38','11','11','张一','男','upload/1742910369727.jpg','13512312312','13512312312');
...
CREATE TABLE `zaixianyuyue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='在线预约';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zaixianyuyue` VALUES (1,'2025-03-25 13:17:47','服务名称1','服务分类1','upload/zaixianyuyue_tupian1.jpg,upload/zaixianyuyue_tupian2.jpg,upload/zaixianyuyue_tupian3.jpg',1,1,1,'2025-03-25','预约详情1','用户账号1','用户姓名1','联系方式1','是','','未支付'),(2,'2025-03-25 13:17:47','服务名称2','服务分类2','upload/zaixianyuyue_tupian2.jpg,upload/zaixianyuyue_tupian3.jpg,upload/zaixianyuyue_tupian4.jpg',2,2,2,'2025-03-25','预约详情2','用户账号2','用户姓名2','联系方式2','是','','未支付'),(3,'2025-03-25 13:17:47','服务名称3','服务分类3','upload/zaixianyuyue_tupian3.jpg,upload/zaixianyuyue_tupian4.jpg,upload/zaixianyuyue_tupian5.jpg',3,3,3,'2025-03-25','预约详情3','用户账号3','用户姓名3','联系方式3','是','','未支付'),(4,'2025-03-25 13:17:47','服务名称4','服务分类4','upload/zaixianyuyue_tupian4.jpg,upload/zaixianyuyue_tupian5.jpg,upload/zaixianyuyue_tupian6.jpg',4,4,4,'2025-03-25','预约详情4','用户账号4','用户姓名4','联系方式4','是','','未支付'),(5,'2025-03-25 13:17:47','服务名称5','服务分类5','upload/zaixianyuyue_tupian5.jpg,upload/zaixianyuyue_tupian6.jpg,upload/zaixianyuyue_tupian7.jpg',5,5,5,'2025-03-25','预约详情5','用户账号5','用户姓名5','联系方式5','是','','未支付'),(6,'2025-03-25 13:17:47','服务名称6','服务分类6','upload/zaixianyuyue_tupian6.jpg,upload/zaixianyuyue_tupian7.jpg,upload/zaixianyuyue_tupian8.jpg',6,6,6,'2025-03-25','预约详情6','用户账号6','用户姓名6','联系方式6','是','','未支付'),(7,'2025-03-25 13:17:47','服务名称7','服务分类7','upload/zaixianyuyue_tupian7.jpg,upload/zaixianyuyue_tupian8.jpg,upload/zaixianyuyue_tupian1.jpg',7,7,7,'2025-03-25','预约详情7','用户账号7','用户姓名7','联系方式7','是','','未支付'),(8,'2025-03-25 13:17:47','服务名称8','服务分类8','upload/zaixianyuyue_tupian8.jpg,upload/zaixianyuyue_tupian1.jpg,upload/zaixianyuyue_tupian2.jpg',8,8,8,'2025-03-25','预约详情8','用户账号8','用户姓名8','联系方式8','是','','未支付'),(9,'2025-03-25 13:48:43','服务1','分类1','upload/1742910461717.jpg',200,2,400,'2025-03-25','<p>测试1</p>','11','张一','13512312312','是','666','未支付');
...
-- Dump completed on 2025-04-03 20:34:47
