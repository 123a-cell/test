		...
		<view class="content">
			<view :style='{"minHeight":"100%","padding":"0 20rpx 20rpx 20rpx","flexWrap":"wrap","background":"#F4F4F4","display":"flex","width":"100%","position":"relative","height":"auto"}'>
				...
				<view :style='{"width":"100%","flexWrap":"wrap","background":"none","display":"flex","height":"auto","order":"5"}'>
					...
					<!-- 样式3 -->
					<view class="news-box3" :style='{"width":"100%","padding":"0","margin":"0","flex":"auto","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"8rpx 40rpx","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"0 0 2rpx 0","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}'>
							...
							<view :style='{"width":"100%","padding":"0 20rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"#6683A2"}' class="title ">{{product.title}}</view>
