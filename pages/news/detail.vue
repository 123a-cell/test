	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#F4F4F4","height":"auto"}'>
			<view :style='{"padding":"24rpx","margin":"-80rpx 0 0","background":"none","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				<view :style='{"margin":"0","borderColor":"#ccc","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"linear-gradient( 135deg, #91DBE8 0%, #F5C3E5 100%)","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="detail-list-item price">
					<view :style='{"padding":"0 20rpx","margin":"12rpx ","borderRadius":"8rpx","background":"#91DBE8","display":"flex"}' v-if="storeupFlag==1" @click="shoucang">
					...
					<view :style='{"padding":"0 20rpx","margin":"12rpx ","borderRadius":"8rpx","background":"#91DBE8","display":"flex"}' v-if="storeupFlag==0" @click="shoucang">
				...
				<view class="detail-list-item" :style='{"padding":"0 0 0 140rpx","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view :style='{"width":"100%","background":"#fff","display":"flex"}'>
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"linear-gradient( 90deg, #F5C3E5 0%, #91DBE8 100%)","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					...
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"linear-gradient( 90deg, #F5C3E5 0%, #91DBE8 100%)","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
					...
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"#91DBE8","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
						...
						<view :style='{"color":"#000","lineHeight":"80rpx","fontSize":"28rpx"}' class="icon iconfont icon-cai11"></view>
					</view>
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"#91DBE8","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
						<view :style='{"padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000","textAlign":"right"}' class="lable">取消踩</view>
						<view :style='{"color":"#000","lineHeight":"80rpx","fontSize":"28rpx"}'>{{detail.crazilynum}}</view>
						<view :style='{"color":"#000","lineHeight":"80rpx","fontSize":"28rpx"}' class="icon iconfont icon-cai11"></view>
					</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"10rpx 24rpx","flexWrap":"wrap","background":"#FFFFFF","display":"flex","gap":"20rpx","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"linear-gradient( 311deg, #91DBE8 0%, #F5C3E5 100%)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('news','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"linear-gradient( 311deg, #91DBE8 0%, #F5C3E5 100%)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('news','私聊')" @tap="chatClick">联系TA</button>
