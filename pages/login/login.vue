<template>
	<view class="content">
		<view class="box" :style='{"width":"100%","padding":"200rpx 60rpx 60rpx","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250220/6ad02edb0d1a4e1787ca36d0259dc20e.png) no-repeat center top / 100% 100%","display":"flex","height":"100%"}'>
			<view :style='{"padding":"40rpx","boxShadow":"0px 4rpx 10rpx 0px rgba(0,0,0,0.3)","borderRadius":"20rpx","background":"#FFFFFF","width":"100%","position":"relative","height":"auto"}'>
				...
				<view v-if="loginType==1" :style='{"border":"none","margin":"0 0 40rpx 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}' class="uni-form-item uni-column">
					...
					<input v-model="username" :style='{"border":"2rpx solid #DFDFDF","padding":"0px 24rpx","margin":"0px","color":"#000","borderRadius":"8rpx","flex":"1","background":"none","fontSize":"28rpx","height":"80rpx"}' type="text" class="uni-input" name="" placeholder="请输入账号" />
				</view>
				<view v-if="loginType==1" :style='{"border":"none","margin":"0 0 40rpx 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}' class="uni-form-item uni-column">
					...
					<input v-model="password" password :style='{"border":"2rpx solid #DFDFDF","padding":"0px 24rpx","margin":"0px","color":"#000","borderRadius":"8rpx","flex":"1","background":"none","fontSize":"28rpx","height":"80rpx"}' type="password" class="uni-input" name="" placeholder="请输入密码" />
				</view>
				...
				<button v-if="loginType==1" class="btn-submit" @tap="onLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"0 0 24rpx 0","color":"#fff","borderRadius":"8rpx","background":"linear-gradient( 133deg, #B6E2EA 0%, #FEC8E3 100%)","width":"100%","lineHeight":"80rpx","fontSize":"32rpx","fontWeight":"600","height":"80rpx"}'>登陆</button>
				<button v-if="loginType==2" class="btn-submit" @tap="onFaceLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"0 0 24rpx 0","color":"#fff","borderRadius":"8rpx","background":"linear-gradient( 133deg, #B6E2EA 0%, #FEC8E3 100%)","width":"100%","lineHeight":"80rpx","fontSize":"32rpx","fontWeight":"600","height":"80rpx"}'>人脸识别登录</button>
				<view class="links" :style='{"width":"100%","margin":"0 0 24rpx 0","flexWrap":"wrap","display":"flex","height":"auto"}'>
					<view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"color":"#74868B","padding":"0 8rpx","fontSize":"28rpx"}'>注册用户</view>
				</view>
